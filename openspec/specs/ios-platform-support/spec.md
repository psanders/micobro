...
Micobro running on iOS as a supported target — the declared iOS permissions
and their Spanish usage strings, which features work natively, which
degrade, and how the E2E suite is exercised on the simulator.
